...
messages = {
    "fr": {
        ...
        "next_script": "\n→ Exécution du script suivant : second_script/tiktok_info.py\n",
        "missing_script": "\n[×] Script introuvable : {}",
    ...
    "en": {
        ...
        "next_script": "\n→ Launching next script: second_script/tiktok_info.py\n",
        "missing_script": "\n[×] Script not found: {}",
...
INPUT_FILE = "Scripts_info_extract/tiktok_profiles.txt"
OUTPUT_FILE = "Scripts_info_extract/profiles_with_email.txt"
...
def main():
    ...
    script_path = os.path.join("second_script", "tiktok_info.py")
